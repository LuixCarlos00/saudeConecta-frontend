...
@Component({
  selector: 'app-planejamento-odontologico-dentista',
  templateUrl: './planejamento-odontologico-dentista.component.html',
  styleUrls: ['./planejamento-odontologico-dentista.component.css'],
})
export class PlanejamentoOdontologicoDentistaComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PlanejamentoOdontologicoDentistaComponent>,
