...
@Component({
  selector: 'app-AtestadoMedico',
  templateUrl: './AtestadoMedico.component.html',
  styleUrls: ['./AtestadoMedico.component.css'],
})
export class AtestadoMedicoComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<AtestadoMedicoComponent>,
